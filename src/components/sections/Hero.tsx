    ...
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden px-8">
      ...
      <div className="text-center z-[2] pt-[72px]">
        <motion.div
          ...
          className="font-cursive text-5xl md:text-7xl lg:text-8xl text-dark mb-3"
        >
          Emma Grave
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-2xl md:text-4xl lg:text-6xl font-light tracking-[8px] md:tracking-[14px] mb-10"
        >
          DÉVELOPPEUSE WEB
        </motion.h1>
        ...
        <motion.div
          ...
          className="text-xl md:text-2xl lg:text-3xl text-gray leading-9"
        >
          Alternante
          <br />—<br />
          BUT Informatique
